...
function Login() {
  ...
  return (
    <div className="login-container" ref={containerRef} style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0077B6 0%, #90E0EF 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem 0' }}>
